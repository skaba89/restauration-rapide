        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/restaurants" className="text-gray-600 hover:text-orange-600 transition-colors">Commander</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-700 rounded-xl font-semibold border border-gray-200 hover:border-orange-300 transition-all group"
                >
                  Essai Restaurant
                  <Play className="ml-2 w-5 h-5 text-orange-600" />
                </Link>
              </motion.div>
